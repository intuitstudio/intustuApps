	...
	public class SafeLoader extends Sprite {
		...
		private function loadDoneCallback(d:DisplayObject):Boolean
		{
			...
			if (d != null) {
				super.addChild(d);
				/*
				conditional below added by Rich Shupe, LearningActionScript3.com
				prevents error: ArgumentError: Error #2025: 
				                The supplied DisplayObject must be a child of the caller.
				    caused by successive loads of non-TLF SWF
				*/
				//super.removeChild(_loader);
				if (super.contains(_loader)) {
					super.removeChild(_loader);
				}
			}
			return true;
